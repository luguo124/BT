...
for p_name in psutil chardet virtualenv Flask Flask-Session Flask-SocketIO flask-sqlalchemy Pillow gunicorn gevent-websocket requests pyopenssl cryptography;
do
	pip install ${p_name}
done
...
pip install psutil chardet virtualenv Flask Flask-Session Flask-SocketIO flask-sqlalchemy Pillow gunicorn gevent-websocket paramiko pyopenssl cryptography
Install_Pillow
Install_psutil
